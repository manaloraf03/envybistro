...
class Income_statement_field extends CORE_Controller
{
    ...
    public function index() {
        ...
        $data['income_accounts']=$this->Journal_info_model->get_account_balance_per_line(4);
        $data['expense_accounts']=$this->Journal_info_model->get_account_balance_per_line(5);
        (in_array('9-22',$this->session->user_rights)? 
        $this->load->view('income_statement_field_view', $data)
