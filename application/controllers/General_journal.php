    ...
    public function transaction($txn=null){
        switch($txn){
            ...
            case 'create' :
                ...
                //if Issuance invoice is available, issuance invoice is recorded as journal
            ...
            case 'cancel':
                ...
                $m_trans->trans_type_id=1; // TRANS TYPE
                $m_trans->trans_log='Cancelled General Journal Entry : '.$journal_txn_no[0]->txn_no.' with reason : '.$this->input->post('cancel_reason');
                }
                $m_trans->save();
                //AUDIT TRAIL END
