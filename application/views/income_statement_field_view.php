            ...
            <div class="static-content"  >
                <div class="page-content"><!-- #page-content -->
                    <ol class="breadcrumb" style="margin:0%;">
                        ...
                        <li><a href="Income_statement">Income Statement (Per Field Report )</a></li>
                    </ol>
                                ...
                                <div class="modal-dialog modal-md">
                                    <div class="modal-content">
                                        <div class="modal-header">
                                            <h4 class="modal-title" style="color: white;">Income Statement (Per Field Report)</h4>
                                        </div>
                                        <div class="modal-body">
                                            ...
                                            <div class="row">
                                                <div class="col-sm-12">
                                                <b class="required">*</b> This report uses the department per line set on every Journal Entry. <br>
                                        ...
                                        <div class="modal-footer">
                                            <div class="col-xs-12">
                                                <a id="btn_print" href="#" target="_blank" class="btn btn-green" style="text-transform:none;font-family: tahoma;" ><i class="fa fa-print" title="Chosen Branch Print"></i> Print </a>
...
<script type="text/javascript">
    $(document).ready(function(){
        ...
        $('#btn_export').click(function(){
            window.open('Income_statement_field/transaction/export-excel?start='+$('#dt_start_date').val()+'&end='+$('#dt_end_date').val());
        });
        ...
        $.ajax({
            "dataType":"json",
            "type":"POST",
            "url":"Income_statement_field/transaction/email-excel?start="+$('#dt_start_date').val()+'&end='+$('#dt_end_date').val(),
    ...
    var showNotification=function(obj){
        ...
        $('#btn_print').click(function(){
         $(this).attr('href',"Templates/layout/income-statement-per-field?type=&type=preview&start="+$('#dt_start_date').val()+"&end="+$('#dt_end_date').val()+"&depid="+_cboDepartments.select2('val'));
