            ...
            <div class="static-content"  >
                <div class="page-content"><!-- #page-content -->
                    ...
                    <ol class="breadcrumb">
                        ...
                        <li><a href="Hotel_control_panel">Control Panel | Hotel System Integration</a></li>
                    </ol>
                    ...
                    <div class="container-fluid">
                        ...
                        <!--     <div class="panel-heading">
                            ...
                            <h2 class="h2-panel-heading">Control Panel | Hotel System Integration</h2><hr>
                                <div class="row">
                                    <div class="container-fluid">
...
$(document).ready(function(){
    ...
    function InitializeDataTable() {
        dt=$('#tbl_replenishment').DataTable({
            "dom": '<"toolbar">frtip',
            "bLengthChange":false,
            "language": {
            ...
            "ajax": {
              "url":"Hotel_control_panel/transaction/list",
              "type":"GET",
              // "order": [[ 6, "desc" ]],
              "data":function (d) {
                return $.extend( {}, d, {
            ...
            "columns": [
                ...
                { targets:[2],data: "customer_item_type" },
                { targets:[3],data: "customer_name" },
                { targets:[4],data: "dr_amount" , render: $.fn.dataTable.render.number( ',', '.', 2 ) },
                { targets:[5],data: "cr_amount" , render: $.fn.dataTable.render.number( ',', '.', 2 ) },
    ...
    //             "dataType":"json",
    //             "type":"POST",
    //             "url":"Hotel_control_panel/transaction/list?aod="+aod
    ...
    var bindEventHandlers=(function(){
        $('#txt_date').change(function(){
            ...
            // InitializeDataTable();
            // getResponse();
            $('#tbl_replenishment').DataTable().ajax.reload()
        });

            var detailRows = [];

            $('#tbl_replenishment tbody').on( 'click', 'tr td.details-control', function () {
                ...
                if ( row.child.isShown() ) {
                    ...
                    $.ajax({
                        "dataType":"html",
                        "type":"POST",
                        "url":"Templates/layout/hotel_control/"+ d.hotel_integration_items_id,
                        "beforeSend" : function(){
        ...
        $('#btn_print').click(function(){
            ...
            return $.ajax({
                "dataType":"json",
                "type":"POST",
                "url":"Hotel_control_panel/transaction/finalize",
                "data":_data
            }).done(function(response){
                    showNotification(response);
                    dt.clear().destroy();
