...
$(document).ready(function(){
    ...
    var initializeControls=function() {
        dt=$('#tbl_products').DataTable({
            ...
            // "scrollX": true,
            "ajax": {
              "url":"Pick_list/transaction/list",
              "type":"GET",
              // "order": [[ 6, "desc" ]],
              "data":function (d) {
                return $.extend( {}, d, {
    ...
    var bindEventHandlers=(function(){
        ...
        $('#btn_print').click(function(){
            window.open('Pick_list/transaction/report?sup='+$('#new_supplier').val()+'&cat='+$('#product_category').val());
        });

        $('#btn_excel').click(function(){
            window.open('Pick_list/transaction/excel?sup='+$('#new_supplier').val()+'&cat='+$('#product_category').val());
        });
        ...
        $.ajax({
            "dataType":"json",
            "type":"POST",
            "url":'Pick_list/transaction/email?sup='+$('#new_supplier').val()+'&cat='+$('#product_category').val(),
            ...
            <div class="static-content"  >
                <div class="page-content"><!-- #page-content -->
                    ...
                    <ol class="breadcrumb" style="margin:0%;">
                        ...
                        <li><a href="Pick_list" id="filter">Reorrder Product (Pick-List)</a></li>
                    </ol>
...
<!--                                             <div class="panel-heading">
                                            ...
                                            <h2 class="h2-panel-heading">Reorder Product (Pick-List)</h2><hr>
                                                <div class="row">
                                                <div class="col-sm-3" >
                                                    Category :
