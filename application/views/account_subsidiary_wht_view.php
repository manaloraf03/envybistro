            ...
            <div class="static-content"  >
                ...
                <div class="page-content"><!-- #page-content -->
                    ...
                    <ol class="breadcrumb" style="margin-bottom: 0px;">
                        ...
                        <li><a href="Account_subsidiary_wht">Account Subsidiary (Withholding Tax)</a></li>
                    </ol>
                                            ...
                                            <div class="panel panel-default" style="border-radius: 6px;border: 1px solid lightgrey;">
                                               <!--  <a data-toggle="collapse" data-parent="#accordionA" href="#collapseTwo"><div class="panel-heading" style="background: #2ecc71;border-bottom: 1px solid lightgrey;;"><b style="color:white;font-size: 12pt;"><i class="fa fa-bars"></i> Per Account Subsidiary</b></div></a> -->
                                                <div id="collapseTwo" class="collapse in">
                                                    ...
                                                    <h2 class="h2-panel-heading">Account Subsidiary (Withholding Tax)</h2><hr>
                                                        <div>
                                                            <div class="row">

                                                                <div class="col-lg-5">
                                                                    Withholding Tax Account * : <br />
    ...
    $(document).ready(function(){
        ...
        var bindEventControls=function(){
            ...
            $(document).on('click','#btn_export',function(){
                window.open('Account_subsidiary_wht/transaction/export-account-subsidiary?type=preview&accountId='+_cboAccounts.val()+'&startDate='+_date_from.val()+'&endDate='+_date_to.val()+'&includeChild='+_cboOptions.val());
        ...
        function createToolBarButton(){
            ...
            var _btnEmail='<button class="btn btn-success" id="btn_email" style="text-transform: none; font-family: Tahoma, Georgia, Serif; " data-toggle="modal" data-target="#salesInvoice" data-placement="left" title="Export" >'+
            ...
            $("div.toolbar").html(_btnExport+"&nbsp;"+_btnRefresh);
        };
        ...
        function reloadList(){
            dt=$('#tbl_account_subsidiary').DataTable({
                ...
                "bPaginate":false,
                "ajax": {
                    "url": "Account_Subsidiary_wht/transaction/get-account-subsidiary-wht",
                    "type": "GET",
                    "bDestroy": true,
                    "data": function ( d ) {
                        return $.extend( {}, d, {
                ...
                "columns": [
                    ...
                    { targets:[2],data: "cv_no" },
                    { targets:[3],data: "supplier_name" },
                    { targets:[4],data: "gross", render: $.fn.dataTable.render.number( ',', '.', 2) },
                    { targets:[5],data: "tax" , render: $.fn.dataTable.render.number( ',', '.', 2)},
                    { targets:[6],data: "net" , render: $.fn.dataTable.render.number( ',', '.', 2)}
