                    ...
                    <ul class="acc-menu">
                        ...
                        <li class="<?php echo (in_array('4',$this->session->parent_rights)?'':'hidden'); ?>"><a href="#/"><i class="ti ti-view-list-alt"></i><span>References</span></a>
                            <ul class="acc-menu">
                                ...
                                <li  class="<?php echo (in_array('4-8',$this->session->user_rights)?'':'hidden'); ?>"><a href="Doc_types">Document Types Management</a></li>
                            ...
                            <ul class="acc-menu parent-menu">
                                ...
                                <li class="hasChild secondChild">
                                    ...
                                    <ul class="acc-menu">
                                        ...
                                        <li class="<?php echo (in_array('9-8',$this->session->user_rights)?'':'hidden'); ?>"><a href="Account_Subsidiary_wht">Account Subsidiary (Tax)</a></li>
