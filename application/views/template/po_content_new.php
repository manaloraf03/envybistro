...
<body>
	...
	<table width="100%" cellpadding="10" cellspacing="-1" class="table table-striped" style="text-align: center;">
		<tr>
			...
			<td style="padding: 6px;border-bottom: 1px solid gray;,text-align: right;"><strong>Qty</strong></td>
			<td style="padding: 6px;border-bottom: 1px solid gray;,text-align: right;"><strong>Unit Price</strong></td>
            <td style="padding: 6px;border-bottom: 1px solid gray;,text-align: right;"><strong>Discount (%)</strong></td>
        ...
        <tr>
            ...
            <td style="padding: 6px;border-bottom: 1px solid gray;height: 30px; border-right: 1px solid gray;" align="right"><?php echo number_format($purchase_info->total_discount+$purchase_info->total_overall_discount_amount,2); ?></td>
        </tr>
        <tr>
