        ...
        <table width="95%" style="border-collapse: collapse;border-spacing: 0;font-family: tahoma;font-size: 11;background-color: transparent!important;" class="nohover" >
            ...
            <?php foreach($adjustment_items as $item){ ?>
                <tr style="background-color: transparent!important ;">
                    ...
                    <td width="12%" style="border-bottom: 1px solid gray;text-align: right;height: 30px;padding: 6px;"><?php echo number_format($item->adjust_qty,4); ?></td>
                    <td width="12%" style="border-bottom: 1px solid gray;text-align: center;height: 30px;padding: 6px;"><?php echo $item->unit_name; ?></td>
                    <td width="12%" style="border-bottom: 1px solid gray;text-align: right;height: 30px;padding: 6px;"><?php echo number_format($item->adjust_price,4); ?></td>

                    <td width="12%" style="border-bottom: 1px solid gray;text-align: right;height: 30px;padding: 6px;"><?php echo number_format($item->adjust_line_total_price,4); ?></td>
                </tr>
            <?php } ?>
            <tr>
            ...
            <tr style="background-color: transparent!important ;">
                ...
                <td style="border-bottom: 1px solid gray;text-align: right;height: 30px;padding: 6px;border-right: 1px solid gray;"><?php echo number_format($adjustment_info->total_discount,4); ?></td>
            </tr>
            <tr style="background-color: transparent!important ;">
                ...
                <td style="border-bottom: 1px solid gray;text-align: right;height: 30px;padding: 6px;border-right: 1px solid gray;"><?php echo number_format($adjustment_info->total_before_tax,4); ?></td>
            </tr>
            <tr style="background-color: transparent!important ;">
                ...
                <td style="border-bottom: 1px solid gray;text-align: right;height: 30px;padding: 6px;border-right: 1px solid gray;"><?php echo number_format($adjustment_info->total_tax_amount,4); ?></td>
            </tr>
            <tr style="background-color: transparent!important ;">
                ...
                <td style="border-bottom: 1px solid gray;text-align: right;height: 30px;padding: 6px;border-right: 1px solid gray;"><strong><?php echo number_format($adjustment_info->total_after_tax,4); ?></strong></td>
            </tr>
            </tfoot>
        </table><br /><br />
    </center>
