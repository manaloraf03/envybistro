    ...
    <table width="100%" cellpadding="3" cellspacing="0" border="1">
    	<thead>
    		<tr>
				...
				<td colspan="4"><strong> TIN # :</strong> <?php echo $supplier->tin_no; ?></strong></td>
			</tr>
    		<th width="15%" align="left">Invoice / OR #</th>
            <th width="8%" align="left">Reference #</th>
    		<th width="8%" align="right">Invoice Amount</th>
            <th width="8%" align="right">Non Vatable</th>
    		<th width="8%" align="right">Vatable</th>

            <th width="8%" align="right">VAT Input</th>
            <th width="8%" align="right">Net of VAT</th>
            <th width="15%" >Account Title</th>
            <th width="8%" align="right">Amount</th>
    	</thead>
    	<tbody>
    		<?php 
    		...
    		<?php foreach($vat_reliefs as $vat_relief) { ?>
    			...
    			<tr>
                   ...
                   <?php  if($vat_relief->journal_id == 0) {?>
                   <td>
                       Not Posted
                   </td>
                   <td></td>
                   <?php } else { ?>
                    ...
                    <?php if($vat_relief->journal_id == $child->journal_id){

                    echo $child->account_title.'<br>'; ?>
                   ...
                   <?php }  } ?>
                    ...
                    echo number_format($child->dr_amount,2).'<br>'; ?>
